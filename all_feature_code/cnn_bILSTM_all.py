...
from keras.callbacks import Callback,ModelCheckpointfrom __future__ import print_function
"""
数据包的导入和创建
"""
import sys
...
wo_ind = Bidirectional(LSTM(32, recurrent_clip_min=-1, recurrent_clip_max=-1, dropout=0.0, recurrent_dropout=0.0,
