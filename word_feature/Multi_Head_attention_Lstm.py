...
save_best_model_file='E:/DeepLearning/bully_code/diyu/model_multi_head_attention_lstm'
...
self_attention=SeqSelfAttention(attention_activation='relu')(embeddings_sequences)
output=LSTM(lstm_output_size,
                          dropout=0.25,
                          recurrent_dropout=0.4)(self_attention)

output=Dense(128,activation='relu',name='dense1')(output)
output=Dense(64,activation='relu',name='dense2')(output)
output=Dense(32,activation='relu',name='dense3')(output)
output=Dense(16,activation='relu',name='dense4')(output)
...
checkpoint_filepath = 'E:/DeepLearning/bully_code/diyu/multi_head_attention_lstm.h5'
