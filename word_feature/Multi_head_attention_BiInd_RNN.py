...
save_best_model_file='E:/DeepLearning/bully_code/diyu/model_multi_head_Biindrnn'
...
selfattention=SeqSelfAttention(attention_activation='relu')(embeddings_sequences)
...
output = Bidirectional(IndRNN(125,
                 recurrent_clip_min=-1,
                 recurrent_clip_max=-1,
                 dropout=0.0,
                 recurrent_dropout=0.0,
...
checkpoint_filepath = 'E:/DeepLearning/bully_code/diyu/multi_head_Biindrnn.h5'
