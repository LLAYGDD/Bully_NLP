...
output=Dense(512,activation='relu',name='dense1')(output)
print(output)
output=Dense(256,activation='relu',name='dense2')(output)
print(output)
output=Dense(128,activation='relu',name='dense3')(output)
print(output)
output=Dense(64,activation='relu',name='dense4')(output)
print(output)
